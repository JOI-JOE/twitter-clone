...
import Emotion from 'vue-material-design-icons/Emoticon.vue';
...
<template>
            ...
            <div class="lg:block hidden lg:w-4/12 h-screen border-l border-gray-800 pl-4">
                ...
                <div class="w-full mt-4 rounded-lg lg:block hidden bg-[#212327]">
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold mb-6 text-[17px]">Doomsday Clock</div>
                                <div class="text-[14px] text-gray-400">5,923 Tweets</div>
                            </div>
                            <DotHorizontal fillColor="#5e5c5c"/>
                        </div>
                    </div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold mb-6 text-[17px]">Sunak</div>
                                <div class="text-[14px] text-gray-400">5,923 Tweets</div>
                            </div>
                            <DotHorizontal fillColor="#5e5c5c"/>
                        </div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                <div class="text-[14px] text-gray-400">Polistic . Trending</div>
                                <div class="w-full text-white font-extrabold mb-6 text-[17px]">Poro</div>
                                <div class="text-[14px] text-gray-400">5,923 Tweets</div>
                            </div>
                            <DotHorizontal fillColor="#5e5c5c"/>
                        </div>
    ...
    <div id="OverlaySection" v-if="createTweet" class="fixed top-0 left-0 w-full h-screen bg-black md:bg-gray-400 md:bg-opacity-30">
        <div class="md:max-w-2xl md:mx-auto md:mt-10 md:rounded-xl bg-black">
            ...
            <div class="w-full flex">
                <div class="ml-3.5 mr-2 rounded-full overflow-hidden w-[55px] h-[55px]">
                    <img  class="w-full" :src="randImg1" alt="">
                </div>
                <div class="w-[calc(100%-100px)]">
                    ...
                    <div class="flex items-center justify-between py-2">
                        <div class="flex items-center">
                            ...
                            <div class="hover:bg-gray-800 inline-block p-2 rounded-full cursor-pointer">
                                <Emotion fillColor="#1C9CEF" :size="25"/>
                            </div>
                        </div>
                        <button
                            :class="tweet ? 'bg-[#1C9CEF] text-white' : 'bg-[#124D77] text-gray-400'"
