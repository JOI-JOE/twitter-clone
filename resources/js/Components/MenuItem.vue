    ...
    <div class="
     ...
     ">
        <div class="flex items-center">
            ...
            <span class="lg:block hidden text-white font-semibold text-[23px]  pl-4 mt-0.5">
                {{ iconString }}
            </span>
        </div>
    </div>
...
import BellOutline from "vue-material-design-icons/BellAlertOutline.vue";
import EmailOutline from "vue-material-design-icons/EmailAlertOutline.vue";
