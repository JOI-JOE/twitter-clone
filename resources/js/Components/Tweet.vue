...
import HearOutline from 'vue-material-design-icons/HeartBoxOutline.vue';
import ChartBar from 'vue-material-design-icons/ChartBar.vue';
import MessageOutline from 'vue-material-design-icons/MessageAlertOutline.vue';
    ...
    <div class="p-2 w-full">
        <div class="font-extrabold flex items-center justify-between mt-0.5 mb-1.5">
            <div class="flex items-center">
                <div>{{ tweet.name }}</div>
                <span class="font-[300] tex-[15px] text-gray-500 pl-2">{{tweet.handle }}</span>
            </div>
        ...
        <div class="flex items-center justify-between mt-4 w-4/5">
            ...
            <div class="flex">
                <HearOutline fillColor="#5e5c5c" :size="18"/>
                <span class="text-xs font-extrabold text-[#5e5c5c] ml-3">
                    {{tweet.comments}}
                </span>
            </div>
